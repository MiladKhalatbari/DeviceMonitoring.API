using DeviceMonitoring.Data.Configurations;
...
public class DeviceMonitoringContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Demo credentials for local Swagger testing only:
        // Username: admin
        // Password: 123456
        modelBuilder.Entity<User>().HasData(
            new
            {
                ...
                PasswordHash = "AQAAAAIAAYagAAAAELbcdwZRum9gGI+cgLxNMa2YGPExgXete3D0UJnJ6aKlpepcnP6PfQ/u428B5hCL7g=="
            });       
        #endregion
